...
//Fragmento que permite a los usuarios buscar películas por género y año.Muestra un spinner con géneros de películas obtenidos desde la API de TMDB
...
public class SlideshowFragment extends Fragment {
    ...
    private List<TMDBMovie.Genre> genreList = new ArrayList<>();
        ...
        call.enqueue(new Callback<TMDBMovie.GenresResponse>() {
            ...
            public void onResponse(Call<TMDBMovie.GenresResponse> call, Response<TMDBMovie.GenresResponse> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    for (TMDBMovie.Genre genre : genreList) {
